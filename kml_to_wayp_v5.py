...
Enhanced with home position optimization and smart waypoint sequencing
"""
...
class KMLToWaypointV5:
    ...
    def generate_vertical_lawnmower(self, polygon: List[Tuple[float, float]]) -> List[Tuple[float, float]]:
        ...
        # Optimize sequence based on home position
    ...
    def print_mission_summary(self, waypoints: List[Tuple[float, float]], home_point: Tuple[float, float]):
        ...
        print(f"Pattern type: Optimized lawnmower with home position optimization")
        print("========================\n")

def main():
    """Enhanced main function with home position optimization"""
    if len(sys.argv) < 3:
        print("KML to ArduPilot Waypoint Converter v5")
        print("Usage: python kml_to_waypoint_v5.py <input.kml> <altitude> [options]")
        print("\nRequired arguments:")
        ...
        print("\nExample:")
        print("  python kml_to_waypoint_v5.py survey_area.kml 50 --spacing 8 --fence-padding 5 --pattern vertical --home-lat 12.345678 --home-lon 78.901234")
        return
    ...
    # Output filename
    output_file = os.path.expanduser("~/ardu-sim/waypoints_v5.txt")
    
    # Create converter
    converter = KMLToWaypointV5(
        altitude=altitude,
        spacing=spacing,
